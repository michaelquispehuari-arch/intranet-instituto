...
6. [Reset total de Railway](./06-reset-total-railway.md) — cómo borrar todos los datos de prueba (o absolutamente todo), solo los estudiantes (Opción C), o uno o varios cursos puntuales con todo lo que dependa de ellos (Opción D, `npm run delete:course`, trae dry run). Usar con cuidado: **el proyecto ya tiene usuarios reales** (desde 2026-07-23), esto ya no es una operación libre de riesgo.
...
- [Registro y cálculo de notas](./REGISTRO_Y_CALCULO_NOTAS.md) — fórmula real de la nota de asistencia (símbolos F/A/M/C/T/J), de dónde sale la NT (transcripción) y la nota de examen, el registro de estudiantes estilo Excel, y los Bloques (agrupación de cursos por ciclo/programa, candado de un solo bloque en progreso, y el promedio que se calcula al "Finalizar ciclo"). **Leer siempre antes de tocar cualquier cosa relacionada a notas/calificaciones** — la fórmula es específica y fácil de romper sin darse cuenta.
