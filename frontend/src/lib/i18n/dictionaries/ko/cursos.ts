...
export const cursos: typeof cursosEs = {
  ...
  bloque: {
    ...
    sinBloque: "블록 없음",
    newBloque: "+ 새 블록",
    newBloqueHeading: "새 블록",
    nameLabel: "블록 이름",
    namePlaceholder: "예: “디플로마” 또는 “2026-2차”",
    createSubmit: "블록 생성",
    finalizadoBadge: "완료됨",
    progress: "{{publicados}}/{{total}} 과정 성적 전송됨",
    finalizeCycle: "학기 마감",
    finalizing: "계산 중…",
    confirmFinalize: "블록 '{{nombre}}'을(를) 마감하시겠습니까? 모든 과정의 평균이 계산되며 되돌릴 수 없습니다.",
    finalized: "블록 '{{nombre}}' 마감 완료. 평균이 게시되었습니다.",
  },
};
