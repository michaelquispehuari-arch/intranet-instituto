// Copia exacta de backend/src/utils/nota-asistencia.ts.
// Se usa SOLO para la vista previa en vivo de la grilla (mientras el admin edita).
// El backend sigue siendo la autoridad: al "Guardar" recalcula y persiste con esta misma fórmula.
